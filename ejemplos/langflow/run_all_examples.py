"""
Script maestro para ejecutar todos los ejemplos de Langflow
...
class LangflowTestRunner:
    """Ejecutor de tests para todos los módulos Langflow"""
    ...
    def run_all_modules(self):
        ...
        print("\n" + "="*70)
        print("PRUEBAS DE LANGFLOW - TODOS LOS MÓDULOS")
        print("="*70)
