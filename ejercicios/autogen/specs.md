# En este directorio hay un coleccion ede ejemplos y ejercicios para crear agentes con Autogen.

## Especificaciones generales

- Cada ejercicio debe tener su propio subdirectorio.
- Cada ejercicio debe usar agentes, tasks, tools y crew de Autogen.
